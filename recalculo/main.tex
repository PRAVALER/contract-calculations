...
\section{Consolidação e atualização dos contratos}{
  ...
  \subsection{Valor das prestações}{
    ...
    \subsubsection{Prestações para aluno novo sem contrato conjunto}{
      ...
      \begin{center}
        \begin{varwidth}{\textwidth}
          \begin{enumerate}
            \item{$v_{a}$\@: valor da adesão do aluno}
            \item{$t_{a}$\@: taxa de adesão do aluno}
            \item{$m_{d}$\@: mensalidade calculada na etapa de contratação}
          \end{enumerate}
        \end{varwidth}
      \end{center}
      \vspace{5mm}
      ...
      \begin{center}
        \begin{varwidth}{\textwidth}
          \begin{enumerate}
            \item{$\mu_{1}$\@: cálculo da primeira prestações}
            \item{$L$\@: tarifa da parcela}
            \item{$t_{adm}$\@: taxa de administração}
          \end{enumerate}
        \end{varwidth}
      \end{center}
      \vspace{5mm}
      ...
      \begin{center}
        \begin{varwidth}{\textwidth}
          \begin{enumerate}
            \item{$\mu_{2}$\@: cálculo da primeira prestações}
          \end{enumerate}
        \end{varwidth}
      \end{center}
      \vspace{5mm}
...
\section{Desperdício computacional}{
  ...
  \subsection{Cálculo dos valores $CETam$ e $CETaa$}{
    ...
    \subsubsection{Encontrando as taxas $x_{t}$ e $x_{t} ^ \prime$}{
    ...
    \subsubsection{Obtenção do valor do $CET_{aa}$}{
    ...
    \subsubsection{Obtenção do valor do $CET_{am}$}{
