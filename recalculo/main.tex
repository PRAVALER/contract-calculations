...
\section{Cálculo da parcela}{
  ...
  \subsection{Cálculo do pagamento}{
    ...
    \subsection{Cálculo do valor amortizado}{
  ...
  \subsection{Cálculo do valor financiado com IOF}{
    Esse é mais um passo do cálculo do contrato. Para que seja possível a obtenção
    deste valor, usamos como input o valor do da parcela anteriormente calculado.
